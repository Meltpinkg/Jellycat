...
def check_two_sv(svtype, start1, end1, start2, end2):
    if svtype == 'INS' and check_two_sv_INS(start1, end1, start2, end2):
        return True
    if svtype == 'DEL' and check_two_sv_DEL(start1, end1, start2, end2):
        return True
    if svtype == 'INV' and check_two_sv_INV(start1, end1, start2, end2):
        return True
    if svtype == 'DUP' and check_two_sv_DUP(start1, end1, start2, end2):
        return True
    if svtype == 'BND' and check_two_sv_BND(start1, end1, start2, end2):
        return True
    return False
